    ...
    <header className={twMerge("flex gap-4 items-center flex-row flex-nowrap", className)}>
      ...
      <div className="flex-1">
        ...
        <div className="flex gap-2.5 text-sm text-secondary items-center">
          <a
            aria-label="Email"
            href="mailto:leviegu@gmail.com"
            className="text-secondary hover:text-primary transition-colors duration-150"
          >
            <AtSign size={14} />
          </a>
          <a aria-label="Github" href="https://github.com/seeintea" target="_blank" rel="noreferrer" className="group">
            <svg
              role="img"
              viewBox="0 0 20 20"
              className="size-3.5 fill-secondary transition-colors duration-150 group-hover:fill-primary"
            >
              <title>Github</title>
          ...
          <a aria-label="X" href="https://x.com/levie_gu" target="_blank" rel="noreferrer" className="group">
            <svg
              role="img"
              viewBox="0 0 24 24"
              className="size-3 fill-secondary transition-colors duration-150 group-hover:fill-primary"
            >
              <title>X</title>
